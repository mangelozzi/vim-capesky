call capesky#init()
" TODO: Break these into ft filetypes
...
redraw
echom printf('Loading CapeSky with contrast: %d, lightness: %d, saturation: %d', g:capesky_contrast, g:capesky_lightness, g:capesky_saturation)
